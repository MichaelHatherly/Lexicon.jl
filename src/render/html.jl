...
function save(file::String, mime::MIME"text/html", doc::Metadata, config::Dict{Symbol, Any})
...
function writemime(io::IO, mime::MIME"text/html", doc::Metadata, config::Dict{Symbol, Any})
    header(io, mime, doc)
...
function footer(io::IO, ::MIME"text/html", doc::Metadata, config::Dict{Symbol, Any})
    println(io, """
