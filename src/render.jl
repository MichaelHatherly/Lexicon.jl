...
*Note:* for the permalink added html anchors have all an additional class attribute called: `lexiconanchor`
which can be used for example to fix html pages generated with MkDocs.

For an example see: source of Pkg: `Lexicon/docs/mkdocshelptheme`
